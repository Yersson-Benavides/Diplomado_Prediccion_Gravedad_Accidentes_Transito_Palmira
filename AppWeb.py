        ...
        dbc.Row(
            dbc.Col(
                [
                    ...
                    dcc.Markdown('##### En este aplicativo web, se presenta un detallado análisis de los incidentes de tráfico registrados en los años 2020, 2021 y 2022. Además, se ofrece la posibilidad de realizar predicciones sobre la gravedad de estos incidentes, tomando en consideración variables cruciales como el lugar (barrio), la franja horaria (jornada) y el día de la semana en que pueda tener lugar el accidente. Este enfoque analítico brinda una visión integral de los patrones y tendencias asociados a los accidentes de tránsito, al tiempo que permite anticipar la severidad de los mismos en función de variables clave.', style={'marginTop':'50px'})
                ],
